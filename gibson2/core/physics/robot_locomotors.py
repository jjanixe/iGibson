...
# class HiderLocobot(LocomotorRobot):
#     def __init__(self, config):
#         self.config = config
...
#         self.linear_velocity = config.get('hider_linear_velocity', 0.5)
#         self.angular_velocity = config.get('hider_angular_velocity', np.pi / 2.0)
#         self.wheel_dim = 2
...
#                                 scale=config.get("robot_scale", 1.0),
#                                 is_discrete=config.get("hider_is_discrete", False),
...
# class SeekerLocobot(LocomotorRobot):
#     def __init__(self, config):
#         self.config = config
#         # https://www.trossenrobotics.com/locobot-pyrobot-ros-rover.aspx
#         # Maximum translational velocity: 70 cm/s
#         # Maximum rotational velocity: 180 deg/s (>110 deg/s gyro performance will degrade)
#         self.linear_velocity = config.get('seeker_linear_velocity', 0.5)
#         self.angular_velocity = config.get('seeker_angular_velocity', np.pi / 2.0)
#         self.wheel_dim = 2
#         self.wheel_axle_half = 0.115  # half of the distance between the wheels
#         self.wheel_radius = 0.038  # radius of the wheels
#         LocomotorRobot.__init__(self,
...
#                                 action_dim=self.wheel_dim,
#                                 scale=config.get("robot_scale", 1.0),
#                                 is_discrete=config.get("seeker_is_discrete", False),
#                                 control="differential_drive")
